...
x3dom.Runtime.prototype.getNodeTreeInfo = function() {
    ...
    var dump = function(t, indent) {
        ...
        types += "<a href='" +
                        x3dom.specBaseURL + x3dom.specURLMap[x3dom.nodeTypes[t]._compName] + "#" + t +
                        "' style='color:black; text-decoration:none; font-weight:bold;'>" +
                        t + "</a> &nbsp; <a href='" +
                        x3dom.specBaseURL + x3dom.specURLMap[x3dom.nodeTypes[t]._compName] +
...
x3dom.Runtime.prototype.getComponentInfo = function() {
    ...
    for (cn in components) {
        ...
        result += "<h2><a href='" +
            x3dom.specBaseURL + x3dom.specURLMap[c] +
            "' style='color:black; text-decoration:none; font-style:italic;'>" +
            c + "</a></h2>";
        ...
        for (var t in component) {
            result += "<li><a href='" +
                x3dom.specBaseURL + x3dom.specURLMap[c] + "#" + t +
                    "' style='color:black; text-decoration:none; font-weight:bold;'>" +
                    t + "</a></li>";
        }
    }
