...
(function(_this){
	...
	_this['resemble'] = function( fileData ){
        ...
        function diffPixel(px, offset, pix1, pix2){
            addBrightnessInfo(pix1);
            addBrightnessInfo(pix2);
            var diff = pix1.brightness - pix2.brightness;
            if(diff>0)
            {
                px[offset + 0] = 0; //r
                px[offset + 1] = 0; //g
                px[offset + 2] = 100+diff; //b
                px[offset + 3] = 255; //a
            }
            else
            {
                diff = 0 - diff;
                px[offset + 0] = 100+diff; //r
                px[offset + 1] = 0; //g
                px[offset + 2] = 0; //b
                px[offset + 3] = 255; //a
            }
...
//					copyPixel(targetPix, offset, pixel2);
					...
					diffPixel(targetPix, offset, pixel1, pixel2);
					mismatchCount++;
				}
