...
const FileBaseURIs = [encodeURI("BitLOD/buddha/G0_"),
                      encodeURI("BitLOD/buddha/G1_"),
                      encodeURI("BitLOD/buddha/G15_"),
                      encodeURI("BitLOD/buddha/G2_"),
                      encodeURI("BitLOD/buddha/G3_"),
                      encodeURI("BitLOD/buddha/G4_"),
                      encodeURI("BitLOD/buddha/G5_"),
                      encodeURI("BitLOD/buddha/G6_"),
                      encodeURI("BitLOD/buddha/G7_"),
                      encodeURI("BitLOD/buddha/G8_"),
                      encodeURI("BitLOD/buddha/G9_"),
                      encodeURI("BitLOD/buddha/G10_"),
                      encodeURI("BitLOD/buddha/G11_"),
                      encodeURI("BitLOD/buddha/G12_"),
                      encodeURI("BitLOD/buddha/G13_"),
                      encodeURI("BitLOD/buddha/G14_")]
