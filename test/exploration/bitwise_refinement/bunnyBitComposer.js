...
load : function(gl)
{
  ...
  for (i = 0; i < NumLevels; ++i) {
    refinementURLs[i] = (encodeURI('bitbunny_aopt_textured/LG_0_level' + i + '.bin'));
  }
  ...
  img.src = "bitbunny_aopt_textured/fractal.png";
  //END GET TEXTURE
  
	//BEGIN GET INDICES
	var xhr = new XMLHttpRequest();
	xhr.open("GET", 'bitbunny_aopt_textured/LG_0_indexBinary.bin', true);
  ...
  texCoordURLs = ['bitbunny_aopt_textured/LG_0_level8.bin',  'bitbunny_aopt_textured/LG_0_level9.bin',
                  'bitbunny_aopt_textured/LG_0_level10.bin', 'bitbunny_aopt_textured/LG_0_level11.bin'];
  for (i = 0; i < 4; ++i) {
