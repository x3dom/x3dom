...
package org.libspark.flartoolkit.core.labeling {
	 ...
	 * 
	 */
	public class FLARLabeling_ARToolKit implements IFLARLabeling {
		...
		private var _out_image:IFLARLabelingImage;
		 ...
		 */
		public function labeling(i_raster:IFLARRaster):void {
			var m:int; /* work */
			var n:int;
			var i:int;
			var j:int;
