...
package org.libspark.flartoolkit.core.labeling {
	...
	public interface IFLARLabelingImage extends IFLARRaster {
		...
		function getContour(i_index:int, i_array_size:int, o_coord_x:Array, o_coord_y:Array):int;

		function getIndexArray():Array; // int[]
		
		function getLabelStack():FLARLabelingLabelStack;

		function reset(i_label_index_enable:Boolean):void;
	}
}