...
x3dom.fields.SFFrustumPlane = function () {
    this.normal = new x3dom.fields.SFVec3f(0, 0, 0);
    this.distance = 0;
}

x3dom.fields.SFFrustumPlane.prototype.normalize = function () {
	var denom = Math.sqrt((this.normal.x*this.normal.x) + (this.normal.y*this.normal.y) + (this.normal.z*this.normal.z));
	this.normal.x /= denom;
	this.normal.y /= denom;
	this.normal.z /= denom;
	this.distance /= denom;
...
x3dom.fields.SFFrustumPlane.prototype.distanceToPoint = function(pt) {
	return this.normal.dot(pt) + this.distance
}
